; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.30501.0 
	...
	TITLE	C:\Users\Simon\Documents\GitHub\Game-of-Life\GraphicsAssign1.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\game-of-life\graphicsassign1.cpp
;	COMDAT _wWinMain@16
_TEXT	SEGMENT
tv147 = -368						; size = 4
tv71 = -368						; size = 4
...
; 44   : 	// Initialise everything in turn
; 45   : 	if( !myScene->InitWindow( hInstance, nCmdShow) )
...
; 48   : 	}
; 49   : 	if( !myScene->InitDevice() || !myScene->LoadEffectFile() || !myScene->InitScene() )
...
; 50   : 	{
; 51   : 		myScene->ReleaseResources(); // Cleanup DirectX on failure
...
; 53   : 	}
; 54   : 
; 55   : 	// Initialise simple input functions (in Input.h/.cpp, not part of DirectX)
; 56   : 	InitInput();

	call	?InitInput@@YAXXZ			; InitInput

; 57   : 
; 58   : 	// Initialise a timer class (in CTimer.h/.cpp, not part of DirectX). It's like a stopwatch - start it counting now
; 59   : 	CTimer Timer;
...
; 61   : 
; 62   : 	// Main message loop. The window will stay in this loop until it is closed
; 63   : 	MSG msg = {0};
...
; 65   : 	{
; 66   : 		// First check to see if there are any messages that need to be processed for the window (window resizing, minimizing, whatever), if there are then deal with them
; 67   : 		// If not then the window is idle and the D3D rendering occurs. This is in a loop. So the window is rendered over and over, as fast as possible as long as we are
; 68   : 		// not manipulating the window in some way
...
; 74   : 		}
; 75   : 		else // Otherwise render & update

	jmp	SHORT $LN1@wWinMain
$LN2@wWinMain:

; 76   : 		{
; 77   : 			myScene->RenderScene();

	mov	ecx, DWORD PTR _myScene$[ebp]
	call	?RenderScene@CScene@@QAEXXZ		; CScene::RenderScene

; 78   : 
; 79   : 			// Get the time passed since the last frame (since the last time this line was reached) - used so the rendering and update can be
; 80   : 			// synchronised to real time and won't be dependent on machine speed
; 81   : 			float frameTime = Timer.GetLapTime();

	lea	ecx, DWORD PTR _Timer$[ebp]
	call	?GetLapTime@CTimer@@QAEMXZ		; CTimer::GetLapTime
	fstp	DWORD PTR _frameTime$5[ebp]

; 82   : 			myScene->UpdateScene( frameTime );
...
; 85   : 
; 86   : 	// Release all the resources we've created before leaving
; 87   : 	myScene->ReleaseResources();
