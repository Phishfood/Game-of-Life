; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.30501.0 
	...
	TITLE	C:\Users\Simon\Documents\GitHub\Game-of-Life\RenderObject.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_TEXT	ENDS
; Function compile flags: /Ogtp
; File c:\users\simon\documents\github\game-of-life\renderobject.cpp
...
; 91   : 		return m_Rotation;
	...
	movq	xmm0, QWORD PTR [eax+20]
	mov	ecx, DWORD PTR [eax+28]
	movq	QWORD PTR _currRotation$[ebp], xmm0
	mov	DWORD PTR _currRotation$[ebp+8], ecx
; File c:\users\simon\documents\github\game-of-life\renderobject.cpp
...
; 108  : 	mWiggleValue += frameTime * mWiggleRate;
	...
	mulss	xmm0, xmm1
	addss	xmm0, DWORD PTR [esi+64]
	movss	DWORD PTR [esi+64], xmm0
; File c:\users\simon\documents\github\game-of-life\model.h

; 111  : 		m_Rotation = rotation;

	movq	xmm0, QWORD PTR _currRotation$[ebp]
	movq	QWORD PTR [eax+20], xmm0
...
; 28   : {
	...
	mov	ebx, DWORD PTR _technique$[ebp]
...
; 523  : 			: _CSTD strlen(_First));
	...
	jne	SHORT $LN51@CRenderObj
	xor	ecx, ecx
	jmp	SHORT $LN52@CRenderObj
$LN51@CRenderObj:
	mov	ecx, edi
...
; 38   : 	mMirrorTechnique = mirrorTechnique;
	...
	mov	eax, DWORD PTR _mirrorTechnique$[ebp]
...
; 42   : 	mNormMap = normmap;
	...
	mov	eax, DWORD PTR _normmap$[ebp]
	mov	DWORD PTR [esi+28], eax

; 43   : 
; 44   : 	mIsLit = lit;

	mov	al, BYTE PTR _lit$[ebp]
...
; 46   : 	mIsTransparent = transparent;
	...
	mov	al, BYTE PTR _transparent$[ebp]
...
; 61   : }
	...
	mov	DWORD PTR [esi+68], 1028443341		; 3d4ccccdH
