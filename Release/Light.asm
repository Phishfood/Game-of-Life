; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.30501.0 
	...
	TITLE	C:\Users\Simon\Documents\GitHub\Game-of-Life\Light.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	__real@3ff00418a0000000
...
CONST	ENDS
;	COMDAT __real@3ff00418a0000000
CONST	SEGMENT
__real@3ff00418a0000000 DQ 03ff00418a0000000r	; 1.001
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Ogtp
; File c:\users\simon\documents\github\game-of-life\light.cpp
...
; 100  : 	mCumulativeTime += frameTime;
	...
	movss	xmm1, DWORD PTR _frameTime$[ebp]
	push	esi
	mov	esi, ecx
...
; 398  :     return D3DXVECTOR3(x + v.x, y + v.y, z + v.z);
	...
	movss	xmm1, DWORD PTR $T3[ebp+4]
	addss	xmm2, DWORD PTR $T1[ebp]
	addss	xmm1, DWORD PTR __real@00000000
; File c:\users\simon\documents\github\game-of-life\model.h
...
; 706  :     return (float)fmod(_X, _Y);
	...
	movsd	QWORD PTR tv568[ebp], xmm0
	movss	xmm0, DWORD PTR [esi+64]
	fld	QWORD PTR tv568[ebp]
	cvtps2pd xmm0, xmm0
; File c:\users\simon\documents\github\game-of-life\light.cpp
...
; 706  :     return (float)fmod(_X, _Y);
	...
	movsd	QWORD PTR tv565[ebp], xmm0
	fld	QWORD PTR tv565[ebp]
	call	__CIfmod
	fstp	QWORD PTR tv559[ebp]
	movsd	xmm0, QWORD PTR tv559[ebp]
	cvtpd2ps xmm0, xmm0
; File c:\users\simon\documents\github\game-of-life\light.cpp
...
; 706  :     return (float)fmod(_X, _Y);
	...
	fld	QWORD PTR tv548[ebp]
	cvtps2pd xmm0, xmm0
	movsd	QWORD PTR tv544[ebp], xmm0
	fld	QWORD PTR tv544[ebp]
	call	__CIfmod
; File c:\users\simon\documents\github\game-of-life\light.cpp
...
; 90   : 	mOldBright = mBrightness;
	...
	mov	WORD PTR [ecx+80], 257			; 00000101H
...
; 48   : 	mOrbitingPoint = point;
	...
	movq	xmm0, QWORD PTR _point$[ebp]
	mov	eax, DWORD PTR _point$[ebp+8]
...
; 42   : 	mOrbitPoint = false;
	...
	mov	WORD PTR [ecx+32], 256			; 00000100H
...
; 706  :     return (float)fmod(_X, _Y);
	...
	fld	QWORD PTR __real@3ff00418a0000000
	call	__CIfmod
...
; 6    : 	mBrightness = 10.0f;
	...
	mov	DWORD PTR [ecx+24], 1092616192		; 41200000H
